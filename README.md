...
A WiFi-based geofencing attendance system with real-time face verification for educational institutions.

## ✨ Features

### 🎯 Real-Time Attendance System (NEW!)
- **WiFi Connection**: Verify student is connected to faculty hotspot
- **Location Verification**: Geofence-based location check (50m radius)
- **Face Recognition**: Real-time face verification via webcam
- **Live Monitoring**: Faculty sees student status in real-time
- **Instant Sync**: Socket.IO powered real-time updates
- **Multi-Factor Security**: Combines WiFi + Location + Face verification

### Student App
- 📱 Connect to classroom WiFi hotspot
- 📍 Location-based geofencing verification (Real-time)
- 👤 Face recognition for identity verification (Real-time)
- 📊 View attendance history and statistics
- 🔔 Real-time notifications
- ✅ Step-by-step attendance marking with validation

### Faculty App
- 📡 Start WiFi hotspot with one click
- 👥 Real-time student attendance monitoring dashboard
- 📊 Live student status: WiFi → Location → Face → Marked
- 📈 View student distance from classroom
- ✏️ Manual attendance override capability
- 📈 Generate attendance reports
- ⏱️ Session timer and statistics
...
- **APIs**: RESTful APIs + Socket.IO events
